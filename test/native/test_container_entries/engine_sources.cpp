// Pulls in the exact translation units the container entry-lookup tests need,
// by #include-ing the real .cpp files by relative path. See
...
#include "../../../lib/meatloaf/media/archive/ark.cpp"
#include "../../../lib/meatloaf/media/archive/lbr.cpp"
#include "../../../lib/meatloaf/media/archive/lnx.cpp"
