// Pulls in the exact translation units the IDE64 CFS (.hdd) read tests need,
...
#include "../../../lib/meatloaf/media/hd/hdd.cpp"

// Link-only stubs for symbols meatloaf.h/hdd.cpp reference but these tests
