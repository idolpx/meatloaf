#!/usr/bin/env python3
"""Test Ollama on C64. Handle rest, inject, run."""
...
# Inline BASIC with uppercase JSON (Ollama accepts it)
prog = (
    ...
    '25 print#1,"b {""MODEL"":""qwen2.5:0.5b"",""MESSAGES"":[{""ROLE"":""USER"",""CONTENT"":""HI""}],""MAX_TOKENS"":5}"\n'
    '30 print#1,"s"\n'
    '35 print#1,"status"\n'
    '36 st$=""\n'
    '37 get#1,a$\n'
...
s = c64.read_screen()
for l in [l.rstrip() for l in s.split('\n') if l.rstrip()]:
    print(f"  [{l}]")
