// Pulls in the exact translation units the M2I read tests need, by
...
#include "../../../lib/meatloaf/media/disk/m2i.cpp"

// Link-only stubs for symbols meatloaf.h/m2i.cpp reference but these tests
// never call. Shared verbatim with the disk-write suite rather than copied.
// Note MFSOwner::File() aborts: resolveEntry() would reach it, so these tests
// stop at entry lookup, which is where the bug under test lives.
