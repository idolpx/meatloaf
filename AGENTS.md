...
- **Hardware-verified on lolin-d32-pro**, console over serial and over TCP:
  ...
  - Block commands, on a `"#"` channel over `goonies.d64`: `U1 2 0 18 1` lands at 91648 and reads
    `12 04 82 11 00 "THE GOONIES"`, `B-R 2 0 18 1` lands at 91649 and reads `04 82 11 00 ...` —
    exactly one byte apart, which is the byte-0 count-byte rule. Bad track and bad sector both
